...
class JOMLCompareTests {
    ...
    fun assertEqualCustomTest() {
        ...
        assertFailsWith<RuntimeException> { assertEqual(joml, kgpu) }
    }
    ...
    @Test
    fun lookAtTest() {
        val joml = JomlMatrix().lookAt(1f, 2f, 3f, 4f, 5f, 6f, 7f, 8f, 9f)
        val kgpu =
            KgpuMatrix()
                .lookAt(
                    Vec3(1f, 2f, 3f),
    ...
    fun transpose() {
        val floats =
            floatArrayOf(1f, 3f, 5f, 7f, 9f, 11f, 13f, 15f, 17f, 19f, 21f, 23f, 25f, 27f, 29f, 31f)
    ...
    fun invert() {
        val floats =
            floatArrayOf(
                4f, 32f, -12f, 0f, 6f, 76f, 91f, 55f, 18f, 33f, -43f, 44f, 2f, 13f, 47f, -9f)
