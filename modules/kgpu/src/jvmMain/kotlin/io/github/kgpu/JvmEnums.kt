...
actual enum class VertexFormat(val nativeVal: Int = Int.MAX_VALUE) {
    UCHAR2,
    UCHAR4,
    CHAR2,
    CHAR4,
    ...
    HALF4,
    FLOAT,
    FLOAT2(WGPUVertexFormat_Float32x2()),
    FLOAT3(WGPUVertexFormat_Float32x3()),
    FLOAT4(WGPUVertexFormat_Float32x4()),
    UINT,
    UINT2,
    UINT3,
    UINT4,
