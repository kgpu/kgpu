...
public class Hooks {
    ...
    private static final Map<String, Consumer<Item>> hooks = Map.of(
            ...
            "WgpuBindGroupLayoutEntry", Hooks::bindGroupLayoutEntryPadding
    );
    ...
    private static StructItem.StructField createPadding(String type){
        return new StructItem.StructField(type, StructItem.doNotUsePrefix + "padding_" + paddingCount++, false);
    }
