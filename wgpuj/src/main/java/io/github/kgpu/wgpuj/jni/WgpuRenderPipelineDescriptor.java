...
public class WgpuRenderPipelineDescriptor extends WgpuJavaStruct {
    ...
    private final WgpuProgrammableStageDescriptor vertexStage =
            inner(WgpuProgrammableStageDescriptor.createHeap());
    private final DynamicStructRef<WgpuProgrammableStageDescriptor> fragmentStage =
            new DynamicStructRef<>(WgpuProgrammableStageDescriptor.class);
    private final DynamicStructRef<WgpuRasterizationStateDescriptor> rasterizationState =
            new DynamicStructRef<>(WgpuRasterizationStateDescriptor.class);
    private final Struct.Enum<WgpuPrimitiveTopology> primitiveTopology =
            new Struct.Enum<>(WgpuPrimitiveTopology.class);
    private final DynamicStructRef<WgpuColorStateDescriptor> colorStates =
            new DynamicStructRef<>(WgpuColorStateDescriptor.class);
    private final Struct.Unsigned64 colorStatesLength = new Struct.Unsigned64();
    private final DynamicStructRef<WgpuDepthStencilStateDescriptor> depthStencilState =
            new DynamicStructRef<>(WgpuDepthStencilStateDescriptor.class);
    private final WgpuVertexStateDescriptor vertexState =
            inner(WgpuVertexStateDescriptor.createHeap());
    ...
    public boolean getAlphaToCoverage() {
        return alphaToCoverage.get();
    }

    public void setAlphaToCoverage(boolean x) {
        this.alphaToCoverage.set(x);
    }
}
