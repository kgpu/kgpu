...
public class WgpuStencilStateDescriptor extends WgpuJavaStruct {
    ...
    private final WgpuStencilStateFaceDescriptor front = inner(WgpuStencilStateFaceDescriptor.createHeap());
    private final WgpuStencilStateFaceDescriptor back = inner(WgpuStencilStateFaceDescriptor.createHeap());
