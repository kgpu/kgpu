...
import io.github.kgpu.wgpuj.jni.LogCallback;
import io.github.kgpu.wgpuj.jni.WgpuJNI;
import io.github.kgpu.wgpuj.jni.WgpuLogLevel;
import java.io.File;
...
public class WgpuJava {
    ...
    /**
     * Loads the given file and creates the bindings in {@link WgpuJNI}. It will then setup the log
     * with the default log callback, and a log level of WARN.
     */
    ...
    /** returns a string of the Wgpu-native library version in the format "major.minor.patch" */
