...
public class WgpuStencilStateFaceDescriptor extends WgpuJavaStruct {
    ...
    private final Struct.Enum<WgpuStencilOperation> failOp =
            new Struct.Enum<>(WgpuStencilOperation.class);
    private final Struct.Enum<WgpuStencilOperation> depthFailOp =
            new Struct.Enum<>(WgpuStencilOperation.class);
    private final Struct.Enum<WgpuStencilOperation> passOp =
            new Struct.Enum<>(WgpuStencilOperation.class);
