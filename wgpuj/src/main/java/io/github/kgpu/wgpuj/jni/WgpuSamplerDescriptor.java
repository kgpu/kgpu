...
public class WgpuSamplerDescriptor extends WgpuJavaStruct {
    ...
    private final Struct.Enum<WgpuAddressMode> addressModeU =
            new Struct.Enum<>(WgpuAddressMode.class);
    private final Struct.Enum<WgpuAddressMode> addressModeV =
            new Struct.Enum<>(WgpuAddressMode.class);
    private final Struct.Enum<WgpuAddressMode> addressModeW =
            new Struct.Enum<>(WgpuAddressMode.class);
    ...
    private final Struct.Enum<WgpuFilterMode> mipmapFilter =
            new Struct.Enum<>(WgpuFilterMode.class);
    private final Struct.Float lodMinClamp = new Struct.Float();
    private final Struct.Float lodMaxClamp = new Struct.Float();
    private final Struct.Enum<WgpuCompareFunction> compare =
            new Struct.Enum<>(WgpuCompareFunction.class);
    private final Struct.Enum<WgpuSamplerBorderColor> borderColor =
            new Struct.Enum<>(WgpuSamplerBorderColor.class);
